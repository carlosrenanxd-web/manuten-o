...
const precos = [
    ...
    },
    {
        ...
        descricao: "Checklist completo de itens elétricos, hidráulicos e estruturais.",
        valor: "R$ 250",
    },
    {
        titulo: "Reparo pontual",
        descricao: "Correção de um problema específico já identificado.",
        valor: "R$ 120",
    },
    {
        titulo: "Ajuste de portas e janelas",
        descricao: "Regulagem de dobradiças, fechaduras e trilhos.",
        valor: "R$ 100",
    },
    {
        titulo: "Fixação de móveis e prateleiras",
        descricao: "Instalação segura com nivelamento.",
        valor: "R$ 90",
    },
    {
        titulo: "Manutenção corretiva emergencial",
        descricao: "Atendimento prioritário para reparos urgentes.",
        valor: "R$ 200",
    },
];
            ...
            <section className="py-20 sm:py-28">
                <div className="max-w-6xl mx-auto px-5 sm:px-8">
                    <span className="inline-flex items-center gap-2 rounded-full bg-cyan-100 px-4 py-2 text-xs font-bold uppercase tracking-wider text-cyan-700">
                        <Wrench size={15} /> Manutenção preventiva e corretiva
                    </span>
                    <div className="max-w-3xl mt-4">
                        <span className="font-mono text-xs tracking-widest uppercase text-signal-600 font-semibold">
                            Detalhes do serviço de manutenção
                        </span>

                        <h1 className="mt-3 font-display font-bold text-4xl text-navy-800">Como funciona nosso atendimento de manutenção</h1>

                        <p className="mt-5 text-lg text-navy-500 leading-relaxed">
                            Atuamos na revisão periódica da casa e no reparo pontual de qualquer problema, antes que vire dor de cabeça. Nosso
                            objetivo é antecipar defeitos, evitar gastos maiores no futuro e manter tudo funcionando com segurança.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-10">
                        <div className="bg-white rounded-xl p-6 border">
                            ...
                            <p className="mt-3 text-navy-500">
                                Fazemos uma vistoria geral da casa, verificando itens elétricos, hidráulicos e estruturais que precisem de atenção.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-6 border">
                            ...
                            <p className="mt-3 text-navy-500">
                                Explicamos ao cliente o que foi encontrado e o que pode virar problema maior se não for tratado a tempo.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-6 border">
                            ...
                            <p className="mt-3 text-navy-500">
                                Após a aprovação, realizamos os reparos e ajustes necessários, deixando tudo funcionando corretamente.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-5">
                    ...
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <p className="mt-4 text-lg text-navy-500">
                            Valores iniciais para os serviços de manutenção mais solicitados.
                        </p>
                    </div>
                            ...
                            <div key={item.titulo} className="relative overflow-hidden rounded-3xl bg-white border border-slate-200 p-8 shadow-sm transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl group">
                                ...
                                <div className="flex justify-between items-start">
                                    <div className="flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-br from-cyan-100 to-blue-100">
                                        <Wrench size={32} className="text-cyan-600" />
                                    </div>
            ...
            <section className="pb-24 py-20">
                <div className="max-w-6xl mx-auto px-5 sm:px-8">
                    <div className="rounded-2xl bg-navy-800 p-10 text-center">
                        <h2 className="text-3xl font-bold text-white">Precisa de manutenção na sua casa?</h2>
